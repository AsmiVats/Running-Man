...
# sheep_rect = sheep_surface.get_rect(midbottom=(600, 310))
...
# text_rect = text_surface.get_rect(center=(400,330))
...
while True:
    ...
    if game_active:
        ...
        # sheep_rect.right -= 5
        # if sheep_rect.right <= 0: sheep_rect.left = 800
        # screen.blit(sheep_surface, sheep_rect)
        ...
        # Collitio
        # if sheep_rect.colliderect(player_rect):
        #    game_active = False
    ...
    clock.tick(60) #game wont run too fast
